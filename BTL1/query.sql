...
--Cau 5: Tim san pham chi duoc ban o chi nhanh 1
SELECT S1.MASP, S1.TENSP
FROM CN1.KHOSANPHAM_QLBH B1 JOIN CN1.SANPHAM S1 ON B1.MASP = S1.MASP
WHERE NOT EXISTS (SELECT S2.MASP, S2.TENSP 
                  FROM CN2.KHOSANPHAM_QLBH@DB_LINK B2 JOIN CN2.SANPHAM@DB_LINK S2 ON B2.MASP = S2.MASP);

--Cau 6: Dem so nhan vien o 2 chi nhanh (cau nay thi moi chi nhanh phai co cn1 cn2 trong bang chi nhanh)
...
SELECT S.MASP, S.TENSP MAX(KHUYENMAI) AS "KHUYENMAI_CAONHAT",  COUNT(MACHINHANH) AS "TONG_CHINHANH"
FROM (SELECT *
...
--Cau 8: Tinh tong cac hoa don o 2 chi nhanh (cau nay thi moi chi nhanh phai co cn1 cn2 trong bang chi nhanh)
